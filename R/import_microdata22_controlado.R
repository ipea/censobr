...
schema_households <- function() {
  # Domicilios -- 64 variables: 50 i8, 4 i16, 6 i32, 1 i64, 3 dbl
...
schema_families <- function() {
  # Familia -- 31 variables: 19 i8, 3 i16, 5 i32, 1 i64, 2 dbl, 1 chr
...
schema_mortality <- function() {
  # Mortalidade -- 25 variables: 14 i8, 3 i16, 5 i32, 1 i64, 1 dbl, 1 chr
...
schema_population <- function() {
  # Pessoas -- 210 variables: 177 i8, 12 i16, 14 i32, 6 i64, 1 dbl
