...
- `DEC == 0` becomes an integer sized by `INT`: up to 4, `int32()` up to
  9 and `int64()` for the 10 digit codes. The "area de ponderacao" is
  one of the latter: from state 22 onwards it is above 2147483647 and
