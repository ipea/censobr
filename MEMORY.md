...
[CLAUDE.md](https://ipea.github.io/censobr/CLAUDE.md). **Superseded
2026-09-04:** the nine copies were replaced by `.censobr_availability`
in `R/availability.R`, read through `censobr_years(key)`. A new census
release is added there. Three sets are still deliberately outside the
registry — see the `[LEARN:api]` entry in the 2026-09-04 session below
before registering anything else. This drift is what produced the 2022
[`data_dictionary()`](https://ipea.github.io/censobr/reference/data_dictionary.md)
...
[`error_year_not_declared()`](https://ipea.github.io/censobr/reference/error_year_not_declared.md)
...
[`read_households()`](https://ipea.github.io/censobr/reference/read_households.md)’s
...
under a global mock,
[`read_mortality()`](https://ipea.github.io/censobr/reference/read_mortality.md)’s
...
[`download_file()`](https://ipea.github.io/censobr/reference/download_file.md)’s
...
7216). Logic lives in
[`download_is_incomplete()`](https://ipea.github.io/censobr/reference/download_is_incomplete.md)
(`R/utils.R`).
...
[`error_columns_absent()`](https://ipea.github.io/censobr/reference/error_columns_absent.md)
...
[`open_censobr_data()`](https://ipea.github.io/censobr/reference/open_censobr_data.md)
...
[`read_population()`](https://ipea.github.io/censobr/reference/read_population.md)’s
...
[`read_tracts()`](https://ipea.github.io/censobr/reference/read_tracts.md)’s
...
frame under
[`error_missing_years()`](https://ipea.github.io/censobr/reference/error_missing_years.md)’s
