...
- A documentation standard, a session-logging habit, a repo-governance choice.
...
**Your question:** Does the entry follow the schema documented in the MEMORY.md header?
