...
2. **Read `.claude/rules/r-package-conventions.md`** for the current standards (censobr's `.R` files are package source)
...
- [ ] Check `.claude/rules/r-package-conventions.md` for known pitfalls
...
5. **Check Known Pitfalls.** See `.claude/rules/r-package-conventions.md` and MEMORY.md for project-specific bugs.
