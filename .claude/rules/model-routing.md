...
| ~20% | **Sonnet 4.6** | Review and critique — `r-reviewer` |
...
- **Roxygen boilerplate / `@template` wiring** (mechanical doc edits under `R/`).
- **NEWS.md bullet formatting** and changelog tidying.
