...
- A **`council` token** that dispatches the formatted prompt to a multi-critic deliberation. Censobr ships the closest fit already: `/promote-memory`'s five-critic council.
